  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        <section className="analysis-grid"><AnalysisCard title="Original mass-only model" subtitle="Altitude vs. total mass · no weather compensation" icon={<Activity size={18} />} accent="blue" model={rawModel} recommendation={rawRecommendation} chart={<RawChart key={zoomReset} data={rawChart} target={targetAltitude} units={units} />} /><AnalysisCard title="Original weather-aware model" subtitle="Compensated for wind, pressure, humidity & temperature" icon={<CloudSun size={18} />} accent="purple" model={adjustedModel} recommendation={adjustedRecommendation} chart={<AdjustedChart key={zoomReset} data={adjustedChart} target={targetAltitude} units={units} />} /></section>
        <PredictionLab launches={graphLaunches} conditions={descentConditions} setConditions={setDescentConditions} targetAltitude={targetAltitude} units={units} />
        <details className="baseline-details"><summary>Original prediction tools · preserved baseline</summary><p>These original formulas remain available for comparison. Their errors and influence scores describe the training data, not validated forecast confidence.</p>
