...
function App() {
  ...
  const onSaveLaunch = async (event: React.FormEvent) => {
    ...
    const launch: Launch = { ...form, id: editingLaunchId ?? crypto.randomUUID() }
