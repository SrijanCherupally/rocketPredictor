...
import { adjustedAltitude, adjustedRegression, descentRegression, linearRegression, median, optimalRocketMass, predictAdjustedAltitude, predictDescentTime, totalMass, type DescentConditions, type Launch, type WeatherReference } from './analytics'
  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        <MassSimulator units={units} model={adjustedModel} fallbackModel={rawModel} targetAltitude={targetAltitude} weather={simulatorWeather} setWeather={setSimulatorWeather} optimalMass={simulatorMass} predictedAltitude={simulatorPrediction} observedMasses={graphLaunches.map(totalMass)} />
        <DescentPredictor units={units} model={descentModel} conditions={descentConditions} setConditions={setDescentConditions} predictedDescent={predictedDescent} />
