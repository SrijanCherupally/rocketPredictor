  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        {activeSection === 'settings' ? <SettingsPanel units={units} setUnits={setUnits} targetAltitude={targetAltitude} setTargetAltitude={setTargetAltitude} /> : activeSection === 'flights' ? <FlightsPanel launches={launches} displayAltitude={displayAltitude} displayMass={displayMass} displayWind={displayWind} displayTemperature={displayTemperature} exportData={exportData} onDelete={removeLaunch} onEdit={editLaunch} onNew={openNewLaunch} /> : <>
