...
function App() {
  ...
  const [descentConditions, setDescentConditions] = useState<DescentConditions>({ mass: 578, altitude: 800, parachuteSize: 18, wind: 4, pressure: 29.92, humidity: 50, temperature: DEFAULT_TEMPERATURE, flightTime: 46 })
  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        <DescentSimulator units={units} model={descentModel} conditions={descentConditions} setConditions={setDescentConditions} predictedDescent={predictedDescent} />
